...
Two-phase workflow (<internal-host> can't reach <internal-host> algod):
  Phase A (<internal-host>):  python -m calculator.preseed_old_rewards --export preseed.json --mongo-uri ...
  Phase B (<internal-host>): python -m calculator.preseed_old_rewards --import-publish preseed.json --app-id X ...
